...
load = 1
if load == 1:
    connection = sqlite3.connect("/data/leuven/324/vsc32460/AC/spowtd/Brunei100_44_GS_smooth_insitu_load_remove.sqlite3") #"/data/leuven/324/vsc32460/AC/spowtd/Brunei100_44_GS_smooth_IMERG_load_remove.sqlite3"
    precipitation_data_file = open('/data/leuven/324/vsc32460/AC/spowtd/src/throughfall_Brunei_30min.txt', mode='r') #'/data/leuven/324/vsc32460/AC/spowtd/src/precipitation_Brunei_IMERG_CDF.txt'
    ...
    time_zone_name = 'Africa/Lagos' #'Asia/Brunei'
